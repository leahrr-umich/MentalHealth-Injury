...
***********************************************************;
proc freq data=inj_analysis_17Feb2024 (WHERE=(WGT>0));
table MH inj_at nsh_inj_at unint_at self_at assault_at other_at undet_at;
table sex*coh / norow nocol nopercent;
table sex*coh*(MH unint_at self_at assault_at) / norow nocol nopercent;*30 years;
table sex*coh*(inj_unint inj_self inj_assault) / norow nocol nopercent;*post-inj;
run;

proc sort data=inj_analysis_17Feb2024; by MH; run;
proc means data=inj_analysis_17Feb2024 (where=(wgt>0));
var n_inj_at nsh_n_inj_at; by MH; 
run;
...
proc genmod data=inj_analysis_17Feb2024;
model inj_self=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
...
proc genmod data=inj_analysis_17Feb2024;
model nsh_tbi=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
...
proc genmod data=inj_analysis_17Feb2024;
model nsh_othheadfaceneck=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
...
proc genmod data=inj_analysis_17Feb2024;
model nsh_spineback =MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
...
proc genmod data=inj_analysis_17Feb2024;
model nsh_torso =MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
...
proc genmod data=inj_analysis_17Feb2024;
model nsh_extremities =MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
...
proc genmod data=inj_analysis_17Feb2024;
model nsh_unclassified=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
...
model inj_unint_assault=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
estimate 'Assault beta' MH 1 / exp;
run;
...
*total population;
proc genmod data=inj_analysis_7Apr2024;
model inj_unint_dirty=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
estimate 'Unintentional beta' MH 1 / exp;
run;
...
proc genmod data=inj_analysis_7Apr2024;
model inj_self_dirty=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
estimate 'Self harm beta' MH 1 / exp;
run;
...
proc genmod data=inj_analysis_7Apr2024;
model inj_assault_dirty=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
estimate 'Assault beta' MH 1 / exp;
run;
...
proc genmod data=inj_analysis_7Apr2024;
model nsh_tbi_dirty=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
estimate 'TBI beta' MH 1 / exp;
run;
...
proc genmod data=inj_analysis_7Apr2024;
model nsh_othheadfaceneck_dirty=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
estimate 'OTHER HEAD FACE & NECK beta' MH 1 / exp;
run;
...
proc genmod data=inj_analysis_7Apr2024;
model nsh_spineback_dirty =MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
estimate 'SPINE & BACK beta' MH 1 / exp;
run;
...
proc genmod data=inj_analysis_7Apr2024;
model nsh_torso_dirty =MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
estimate 'TORSO beta' MH 1 / exp;
run;
...
proc genmod data=inj_analysis_7Apr2024;
model nsh_extremities_dirty =MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
estimate 'EXTREMITIES beta' MH 1 / exp;
run;
...
proc genmod data=inj_analysis_7Apr2024;
model nsh_unclassified_dirty=MH prev_inj dia_bir_birth_year_nbr sex/ dist = poisson link = log;
weight wgt;
estimate 'UNCLASSIFIED beta' MH 1 / exp;
run;
