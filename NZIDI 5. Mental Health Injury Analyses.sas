...
IDI_Metadata_202303.data.Dep_Index13
IDI_Metadata_202303.data.meshblock_concordance
;

***OUTPUT DATASETS***
burden
totpop_dep
file.inj_analysis_7Apr2024
;
*********************************************************************;
...
data file.totpop_dep; set totpop_dep; run;
...
****ANALYSIS 4 = MH TYPE BY INJURY TYPE;

%macro analysis4(inj,mhtype);
proc genmod data=inj_analysis_7Apr2024;
...
%analysis4(inj = inj_unint_dirty, mhtype = Anxiety_clean);
%analysis4(inj = inj_unint_dirty, mhtype = Mood_clean);
%analysis4(inj = inj_unint_dirty, mhtype = Psychosis_clean);
%analysis4(inj = inj_unint_dirty, mhtype = SUD_clean);

%analysis4(inj = inj_self_dirty, mhtype = Anxiety_clean);
%analysis4(inj = inj_self_dirty, mhtype = Mood_clean);
%analysis4(inj = inj_self_dirty, mhtype = Psychosis_clean);
%analysis4(inj = inj_self_dirty, mhtype = SUD_clean);

%analysis4(inj = inj_assault_dirty, mhtype = Anxiety_clean);
%analysis4(inj = inj_assault_dirty, mhtype = Mood_clean);
%analysis4(inj = inj_assault_dirty, mhtype = Psychosis_clean);
%analysis4(inj = inj_assault_dirty, mhtype = SUD_clean);

%analysis4(inj = nsh_tbi_dirty, mhtype = Anxiety_clean);
%analysis4(inj = nsh_tbi_dirty, mhtype = Mood_clean);
%analysis4(inj = nsh_tbi_dirty, mhtype = Psychosis_clean);
%analysis4(inj = nsh_tbi_dirty, mhtype = SUD_clean);

%analysis4(inj = nsh_othheadfaceneck_dirty, mhtype = Anxiety_clean);
%analysis4(inj = nsh_othheadfaceneck_dirty, mhtype = Mood_clean);
%analysis4(inj = nsh_othheadfaceneck_dirty, mhtype = Psychosis_clean);
%analysis4(inj = nsh_othheadfaceneck_dirty, mhtype = SUD_clean);

%analysis4(inj = nsh_spineback_dirty, mhtype = Anxiety_clean);
%analysis4(inj = nsh_spineback_dirty, mhtype = Mood_clean);
%analysis4(inj = nsh_spineback_dirty, mhtype = Psychosis_clean);
%analysis4(inj = nsh_spineback_dirty, mhtype = Anxiety_clean);

%analysis4(inj = nsh_torso_dirty, mhtype = Anxiety_clean);
%analysis4(inj = nsh_torso_dirty, mhtype = Mood_clean);
%analysis4(inj = nsh_torso_dirty, mhtype = Psychosis_clean);
%analysis4(inj = nsh_torso_dirty, mhtype = SUD_clean);

%analysis4(inj = nsh_extremities_dirty, mhtype = Anxiety_clean);
%analysis4(inj = nsh_extremities_dirty, mhtype = Mood_clean);
%analysis4(inj = nsh_extremities_dirty, mhtype = Psychosis_clean);
%analysis4(inj = nsh_extremities_dirty, mhtype = SUD_clean);

%analysis4(inj = nsh_unclassified_dirty, mhtype = Anxiety_clean);
%analysis4(inj = nsh_unclassified_dirty, mhtype = Mood_clean);
%analysis4(inj = nsh_unclassified_dirty, mhtype = Psychosis_clean);
%analysis4(inj = nsh_unclassified_dirty, mhtype = SUD_clean);
